// ============================================================
// FILE: lib/views/screens/provider/provider_messages_screen.dart
// Provider chat — lists patients who booked appointments with
// the provider, and opens a real-time chat with each of them.
// ============================================================
...
// ─── Conversation avatar (resolves real uploaded image) ────────────────────────

class _ProviderConvAvatar extends StatefulWidget {
  final String? imageUrl;
  final String participantId;
  final String initials;
  final Color color;

  const _ProviderConvAvatar({
  ...
  @override
  State<_ProviderConvAvatar> createState() => _ProviderConvAvatarState();
}

class _ProviderConvAvatarState extends State<_ProviderConvAvatar> {
  String? _resolvedUrl;
  ...
  @override
  void didUpdateWidget(covariant _ProviderConvAvatar oldWidget) {
