  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? AppColors.providerColor : AppColors.background,
          borderRadius: BorderRadius.circular(20.r),
          border: Border.all(
            color: selected ? AppColors.providerColor : AppColors.border,
          ),
        ),
        child: Row(
          children: [
            ...
            if (count > 0) ...[
              ...
              Text(
                ...
                style: AppTextStyles.badge.copyWith(
                  color: selected ? Colors.white : AppColors.providerColor,
                  fontSize: 10.sp,
                ),
              ),
            ],
...
class _ScheduleCard extends StatelessWidget {
  ...
  const _ScheduleCard({required this.appointment, required this.ctrl});
  ...
  @override
  Widget build(BuildContext context) {
    final isActionable = appointment.status == AppointmentStatus.confirmed ||
        appointment.status == AppointmentStatus.pending;

    // The "Complete" button only appears once the appointment's time slot
    // has finished (start time + duration is in the past).
    final endTime =
        appointment.dateTime.add(Duration(minutes: appointment.durationMins));
        ...
        children: [
            ...
            child: Row(
              children: [
                _ScheduleAvatar(
                  ...
                  fallbackEmoji: appointment.avatarEmoji,
                ),
                SizedBox(width: 12.w),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4.h),
                      Text(
                        '${_formatTime(appointment.dateTime)} · ${appointment.typeLabel} · ${appointment.durationMins} mins',
          ...
          if (isActionable)
            Padding(
              ...
              child: appointment.status == AppointmentStatus.pending
                  ? Row(
                      children: [
                        Expanded(
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () =>
                                ctrl.confirmAppointment(appointment.id),
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                                onPressed: () {
                                  ...
                                  final ids = [currentUserId, appointment.patientId]..sort();
                                  ...
                                  Get.toNamed(
                                    ...
                                    arguments: ConversationModel(
                                      ...
                                      participantSpecialty: appointment.reason,
                        ...
                        if (hasEnded) ...[
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () =>
                                  ctrl.completeAppointment(appointment.id),
                              style: ElevatedButton.styleFrom(
...
// ─── Schedule Avatar (resolves real uploaded image) ───────────────────────────
class _ScheduleAvatar extends StatefulWidget {
  ...
  @override
  State<_ScheduleAvatar> createState() => _ScheduleAvatarState();
}

class _ScheduleAvatarState extends State<_ScheduleAvatar> {
  String? _resolvedUrl;
  ...
  @override
  void didUpdateWidget(covariant _ScheduleAvatar oldWidget) {
